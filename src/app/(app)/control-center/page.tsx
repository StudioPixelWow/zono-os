// ============================================================================
// 📊 ZONO — מרכז הבקרה (CONTROL CENTER) — "מה קורה בעסק שלי?".
// The full business-intelligence dashboard. This is the EXACT rich dashboard that
// used to be the default Home — moved here UNCHANGED so nothing is lost. The new
// default Home ("היום שלי") is the zero-scroll daily cockpit at `/`. May scroll
// vertically (analytical, data-rich). COMPOSITION ONLY — reuses the existing
// dashboard-home pipeline + broker-intelligence queue; nothing is mocked.
// ============================================================================
...
export default async function Home() {
  ...
  // Props are RESOLVED inside the try; the JSX is returned outside it (lint: no JSX in try/catch).
  ...
  try {
    ...
    console.error("[control-center] activation resolve failed — falling back to dashboard:", e);
  }
