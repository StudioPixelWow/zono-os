...
/** Public invitation landing page. Validates the token and guides the invited
 *  agent to sign up with the invited email. (Auto-attach on signup is wired in
        ...
        {valid ? (
          <>
            ...
            <p className="text-muted mt-3 text-sm leading-relaxed">
              ...
              להצטרפות, הירשם/י עם כתובת האימייל <span className="text-ink font-bold" dir="ltr">{invite!.email}</span>.
            </p>
