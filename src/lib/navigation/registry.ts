...
export const MODULES: ModuleEntry[] = [
  ...
  { id: "mission-control", label: "🧠 מרכז בקרת AI", route: "/mission-control", icon: "Sparkles", category: "ראשי", roleMin: "agent", sidebar: false, searchable: true, description: "AI Mission Control™ — מערכת ההפעלה של ה-AI (לא צ׳אט): משימת הבוקר, הקשר הסשן, לוח הקשר, תור המשימות מהפיד הקיים וזיכרון AI" },
  ...
  { id: "market-dashboard", label: "📊 דשבורד שוק", route: "/market-intelligence/dashboard", icon: "BarChart3", category: "שוק ועסקאות", roleMin: "agent", sidebar: true, searchable: true, description: "Market Intelligence Dashboard™ — תקציר בוקר: מה השתנה, אזורים חמים, מומנטום, רדאר ופיד מודיעין" },
  { id: "broker-dashboard", label: "📊 דשבורד מתווכים", route: "/broker-intelligence/dashboard", icon: "BarChart3", category: "שוק ועסקאות", roleMin: "manager", sidebar: false, searchable: true, description: "Broker Intelligence Dashboard™ — מובילים, ביטחון נתונים ומלאי" },
  { id: "office-dashboard", label: "📊 דשבורד משרדים", route: "/office-intelligence/dashboard", icon: "BarChart3", category: "שוק ועסקאות", roleMin: "manager", sidebar: false, searchable: true, description: "Office Intelligence Dashboard™ — משרדים מובילים, צומחים, מומנטום ואיום" },
  { id: "neighborhood-dashboard", label: "📊 דשבורד שכונות", route: "/neighborhood-intelligence/dashboard", icon: "BarChart3", category: "שוק ועסקאות", roleMin: "agent", sidebar: false, searchable: true, description: "Neighborhood Dashboard™ — פעילות, הזדמנויות אוף-מרקט ומובילים" },
  { id: "live-market-map", label: "🗺️ מפת שוק חיה", route: "/market-intelligence/map", icon: "MapPin", category: "שוק ועסקאות", roleMin: "agent", sidebar: true, searchable: true, description: "מפת מודיעין חיה — מפת חום משוקללת, שכבות חכמות, סינון חי, השוואת אזורים, דשבורד טריטוריה ותצוגת נכס פנימית" },
  ...
  { id: "competition-radar", label: "רדאר מתחרים", route: "/competition-radar", icon: "Target", category: "שוק ועסקאות", roleMin: "manager", sidebar: true, searchable: true, description: "רדאר מתחרים™ — מודיעין תחרותי על משרדי תיווך: ציוני איום, שליטה אזורית, אותות שוק, ניתוח SWOT והמלצות פעולה" },
  ...
  { id: "my-office-vs-market", label: "המשרד שלי מול השוק", route: "/brokerage-data/my-office", icon: "Target", category: "שוק ועסקאות", roleMin: "manager", sidebar: true, searchable: true, description: "המשרד שלי מול השוק — זיהוי המשרד שלך (לפי זהות, לא לפי שם), הנתח שלך מתוך המלאי שנצפה על ידי ZONO, חמשת המתחרים הישירים המובילים ותובנות הזדמנות" },
  { id: "office-intelligence-directory", label: "מודיעין המשרדים", route: "/brokerage-data/offices", icon: "Building", category: "שוק ועסקאות", roleMin: "manager", sidebar: true, searchable: true, description: "מודיעין המשרדים — זירת המשרדים הפעילים, פרופיל מלא לכל משרד, טריטוריה, מתחרים ישירים ומומנטום, מבוסס על המלאי הנצפה" },
