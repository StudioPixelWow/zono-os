...
function testModelConfig() {
  ...
  ok("gpt-image-2 & 1 supported", (SUPPORTED_IMAGE_MODELS as readonly string[]).includes("gpt-image-2") && (SUPPORTED_IMAGE_MODELS as readonly string[]).includes("gpt-image-1"));
