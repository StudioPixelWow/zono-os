...
export type MetaNotificationEventName =
  ...
  | "meta.post.scheduled"
  | "meta.post.scheduled_cancelled"
  | "meta.post.retry_scheduled"
  | "meta.post.dead_lettered"
  | "meta.post.published"
  | "meta.post.partially_published"
  | "meta.post.failed"
  | "meta.post.manual_review_required"
  | "meta.post.verified"
  | "meta.post.discrepancy_detected"
  | "meta.post.provider_deleted"
  | "meta.post.provider_hidden"
  | "meta.post.ambiguous_resolved"
