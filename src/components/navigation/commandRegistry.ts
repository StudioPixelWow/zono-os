...
export const QUICK_ACTIONS: CommandItem[] = [
  ...
  { id: "qa-lead", label: "ליד חדש", icon: "MessageCircle", category: "פעולות", type: "action", action: "zono:new-lead", keywords: ["ליד", "lead"] },
  { id: "qa-deal", label: "עסקה חדשה", icon: "Briefcase", category: "פעולות", type: "action", action: "zono:new-deal", keywords: ["עסקה", "deal"] },
  { id: "qa-meeting", label: "פגישה חדשה", icon: "Calendar", category: "פעולות", type: "action", action: "zono:new-meeting", keywords: ["פגישה", "meeting"] },
  { id: "qa-task", label: "משימה חדשה", icon: "ListChecks", category: "פעולות", type: "action", action: "zono:new-task", keywords: ["משימה", "task"] },
...
export const SYSTEM_MAP: SystemGroup[] = [
  {
    key: "home", title: "בית ושליטה", icon: "Home", items: [
      ...
      { id: "command", label: "מרכז פיקוד AI", description: "מרכז ההחלטות הניהולי", href: "/command", icon: "Flame", category: "עמודים", group: "home", type: "page", keywords: ["פיקוד", "decision"] },
      { id: "today", label: "מוקד היום", description: "מרכז יומי — מה דורש טיפול עכשיו", href: "/today", icon: "Target", category: "עמודים", group: "home", type: "page", keywords: ["daily os", "היום"] },
      { id: "my", label: "שולחן העבודה שלי", description: "שולחן עבודה של מתווך", href: "/my", icon: "Users", category: "עמודים", group: "home", type: "page", keywords: ["workspace", "broker"] },
      { id: "executive", label: "מוח ניהולי", description: "מודיעין מנהלים", href: "/executive", icon: "Sparkles", category: "עמודים", group: "home", type: "page", keywords: ["executive", "ceo", "ציון ארגון"] },
      { id: "office-manager", label: "מנהל המשרד", description: "מנהל משרד AI — עומס צוות, האצלות, מעקבים ואישורים", href: "/office-manager", icon: "Users", category: "עמודים", group: "home", type: "page", keywords: ["manager", "מנהל", "משרד", "עומס", "צוות", "האצלה", "workload"] },
      { id: "notifications", label: "התראות", href: "/notifications", icon: "Bell", category: "עמודים", group: "home", type: "page" },
      { id: "calendar", label: "יומן", description: "יומן — סדר יום, מסלול, פגישות", href: "/calendar", icon: "Calendar", category: "עמודים", group: "home", type: "page", keywords: ["calendar", "לוח שנה"] },
    ],
  },
  {
  ...
  },
  {
    key: "properties", title: "נכסים ושוק", icon: "Building", items: [
      ...
      { id: "market", label: "מודיעין שוק", href: "/market", icon: "BarChart3", category: "נכסים", group: "properties", type: "page", keywords: ["מודיעין שוק"] },
      { id: "marketplace", label: "מרקטפלייס", description: "מודיעין זירה — הזדמנויות רכישה והתאמות מהשוק החיצוני", href: "/marketplace", icon: "Building", category: "נכסים", group: "properties", type: "page", keywords: ["marketplace", "yad2", "madlan", "חיצוני", "רכישה", "acquisition", "external"] },
  ...
  },
  {
    key: "deals", title: "עסקאות וניהול", icon: "Briefcase", items: [
      ...
      { id: "pipeline", label: "צנרת עסקאות", href: "/forecast", icon: "TrendingUp", category: "עסקאות", group: "deals", type: "page", keywords: ["פייפליין", "תחזית"] },
  ...
  },
  {
    key: "marketing", title: "שיווק והפצה", icon: "Megaphone", items: [
      ...
      { id: "fb-groups", label: "קבוצות פייסבוק", href: "/distribution/groups", icon: "Users", category: "עמודים", group: "marketing", type: "page", keywords: ["קבוצות"] },
  ...
  },
  {
    key: "ai", title: "AI ואוטומציות", icon: "Sparkles", items: [
      { id: "brain", label: "מוח הברוקר", description: "מוח ברוקר AI — מטרה אסטרטגית → תוכנית פעולה", href: "/brain", icon: "Sparkles", category: "AI", group: "ai", type: "ai", keywords: ["broker brain", "מוח", "תוכנית", "בלעדיות", "מטרה", "goal", "plan"] },
      { id: "relationships", label: "גרף הקשרים", description: "גרף ידע אוניברסלי — קשרים מבוססי ראיות בין כל הישויות", href: "/relationships", icon: "Route", category: "AI", group: "ai", type: "ai", keywords: ["graph", "גרף", "קשרים", "knowledge graph", "relationships", "מחובר"] },
      { id: "voice", label: "זיכרון קולי", description: "עוזר קולי — תמלול → סיכום, ישויות והצעות לאישור", href: "/voice", icon: "MessageCircle", category: "AI", group: "ai", type: "ai", keywords: ["voice", "קול", "תמלול", "הקלטה", "transcript", "פגישה"] },
      { id: "learning", label: "מה למדנו", description: "AI לומד — אילו קופי/קבוצות/שעות/אזורים עובדים", href: "/learning", icon: "TrendingUp", category: "AI", group: "ai", type: "ai", keywords: ["למידה", "learning", "דפוסים", "patterns", "מה עובד", "insights"] },
      { id: "ai-insights", label: "תובנות AI", href: "/ai-office", icon: "Sparkles", category: "AI", group: "ai", type: "ai" },
      { id: "opportunity-radar", label: "רדאר הזדמנויות", href: "/command", icon: "Activity", category: "AI", group: "ai", type: "ai", keywords: ["הזדמנויות"] },
      { id: "recommendations", label: "המלצות", href: "/recommendations", icon: "Sparkles", category: "AI", group: "ai", type: "ai", keywords: ["המלצות"] },
      { id: "agents", label: "סוכנים", icon: "Users", category: "AI", group: "ai", type: "ai", beta: true },
      { id: "automations", label: "אוטומציות", href: "/automation", icon: "Layers", category: "AI", group: "ai", type: "ai", keywords: ["אוטומציה"] },
      { id: "smart-matching", label: "התאמה חכמה", href: "/matches", icon: "Target", category: "AI", group: "ai", type: "ai" },
      { id: "negotiation", label: "עוזר מו״מ", description: "עוזר מו״מ AI — אסטרטגיה, תסריטים והכנה לפגישה", href: "/negotiation", icon: "Handshake", category: "AI", group: "ai", type: "ai", keywords: ["negotiation", "מו״מ", "משא ומתן", "הצעה", "offer", "אסטרטגיה"] },
      { id: "predictions", label: "תחזיות שוק", href: "/forecast", icon: "TrendingUp", category: "AI", group: "ai", type: "ai", keywords: ["תחזיות"] },
      { id: "prediction-engine", label: "מנוע התחזיות", description: "מנוע תחזיות — נטישה, סגירה, המרה, עומס, טריטוריה", href: "/predictions", icon: "Sparkles", category: "AI", group: "ai", type: "ai", keywords: ["תחזית", "forecast", "prediction", "churn", "סבירות", "חיזוי"] },
    ],
  },
  {
  ...
  },
  {
    key: "system", title: "מערכת והגדרות", icon: "Settings", items: [
      ...
      { id: "billing", label: "חיוב", href: "/settings/plan", icon: "Tag", category: "עמודים", group: "system", type: "page", keywords: ["חבילה", "חיוב"] },
