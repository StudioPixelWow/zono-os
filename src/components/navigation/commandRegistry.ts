...
export const SYSTEM_MAP: SystemGroup[] = [
  ...
  },
  {
    key: "ai", title: "AI ואוטומציות", icon: "Sparkles", items: [
      ...
      { id: "voice", label: "זיכרון קולי", description: "Voice AI — תמלול → סיכום, ישויות והצעות לאישור", href: "/voice", icon: "MessageCircle", category: "AI", group: "ai", type: "ai", keywords: ["voice", "קול", "תמלול", "הקלטה", "transcript", "פגישה"] },
      { id: "learning", label: "מה למדנו", description: "Self-Learning AI — אילו קופי/קבוצות/שעות/אזורים עובדים", href: "/learning", icon: "TrendingUp", category: "AI", group: "ai", type: "ai", keywords: ["למידה", "learning", "דפוסים", "patterns", "מה עובד", "insights"] },
